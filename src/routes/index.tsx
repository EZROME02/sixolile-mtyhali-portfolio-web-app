        ...
        <div className="mx-auto flex w-[92%] max-w-6xl items-center justify-between gap-4 py-3">
          <a href="#top" className="flex items-center gap-3">
            ...
            <span className="leading-tight">
              <span className="block font-display text-sm font-bold tracking-tight">EZROME</span>
              <span className="block label-mono text-cyan">Technology Intelligence</span>
            </span>
          </a>
      ...
      <main className="mx-auto w-[92%] max-w-6xl pb-24">
        <section className="grid items-center gap-8 py-10 lg:grid-cols-[1fr_0.8fr]">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href={CV_REQUEST} className="rounded-sm border border-cyan/60 bg-cyan/10 px-5 py-3 font-mono text-[11px] tracking-widest text-cyan uppercase transition hover:bg-cyan/20">Request my CV</a>
        ...
        <Section id="contact" eyebrow="09 / Human connection" title="Contact">
          <div className="glass-card grid gap-4 p-6 sm:grid-cols-3">
            <div><p className="label-mono text-violet">Email</p><a className="mt-2 block text-sm text-cyan hover:underline" href={`mailto:${EMAIL}`}>{EMAIL}</a></div>
            <div><p className="label-mono text-violet">Phone</p><a className="mt-2 block text-sm text-cyan hover:underline" href={`tel:${PHONE.replace(/\s/g, "")}`}>{PHONE}</a></div>
            <div><p className="label-mono text-violet">Status</p><p className="mt-2 text-sm text-muted-foreground">Open to opportunities</p></div>
          </div>
        </Section>

        <footer className="border-t border-border py-10 text-center">
          <p className="label-mono text-cyan">EZROME TECHNOLOGY INTELLIGENCE</p>
