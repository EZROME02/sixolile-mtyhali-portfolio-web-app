...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EZROME — an AI, web, productivity and knowledge platform by Sixolile Ezrome Mtyhali." },
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    const register = () => {
      navigator.serviceWorker.register("/sw.js").catch((error) => console.warn("EZROME offline support could not be enabled", error));
    };
